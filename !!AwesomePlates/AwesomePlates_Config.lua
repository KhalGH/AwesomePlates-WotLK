-------------------------------------------------------------------------------------------
-------------------------- AwesomePlates Configuration Interface --------------------------
-------------------------------------------------------------------------------------------
...
local L = AP.L or {}
local PlatesVisible = AP.PlatesVisible
local me = CreateFrame("Frame", "AwesomePlatesConfig")
AP.Config = me;
...
me.ScaleNormDist.Update = AP.SetScaleNormDist;
...
me.MinScale.Update = AP.SetMinScale;
...
me.MaxScale.Update = AP.SetMaxScale;
